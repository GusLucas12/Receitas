...
const loginUser = async (email, password) => {
    try {
        const response = await fetch(`https://backend-engsoft.onrender.com/user/login?email=${email}&password=${password}`, {
            method: "GET",
            headers: {
        ...
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <div className={styles.infoContainer}>
                    <InputField label="E-mail" type="email" placeholder="remy@cozinha.com" onChange={e => setEmail(e.target.value)} />
                    <InputField
                        label="Senha"
